...
function Player() {
  ...
  return (
    <div className="w-[100%] md:w-[60%] h-[100px] bg-white fixed bottom-[55px] md:bottom-0 rounded-t-[30px] shadow-lg flex  pt-[10px] md:items-center md:p-[20px]">
      <div className="flex justify-start items-start gap-[20px] w-[80%] h-[100%] cursor-pointer pl-[30px] ">
        <div>
          <img
            ...
            alt=""
            className="w-[60px] max-h-[60px] md:max-h-[80px] md:w-[100px] rounded-lg object-fill"
          />
        </div>

        <div className="text-[20px] md:text-[25px]">
          <div className="text-black text-[1.1em] font-semibold text-center">
            {songsData[index].name}
          </div>
          <div className="text-gray-800 text-[0.7em] font-semibold text-center">
      ...
      {!playingSong ? (
        <div
          className="w-[50px] h-[50px] rounded-full bg-black text-white flex justify-center items-center hover:bg-gray-500 transition-all cursor-pointer"
          onClick={() => playSong()}
        >
